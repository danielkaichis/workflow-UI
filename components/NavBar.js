const NavBar = () => (
    ...
    <div class="flex flex-col sm:flex-row sm:justify-left">
        <div class="w-64 h-screen bg-gray-800 mt-8 sm:mt-0">
            <div class="flex items-center justify-center mt-10">
                <img class="h-6" src="https://premium-tailwindcomponents.netlify.app/assets/svg/tailwindcomponent-light.svg"></img>
            </div>
            <nav class="mt-10">
                <a class="flex items-center py-2 px-8 bg-gray-700 text-gray-100 border-l-4 border-gray-100" href="#">
                ...
                <a class="flex items-center mt-5 py-2 px-8 text-gray-400 border-l-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100" href="#">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
